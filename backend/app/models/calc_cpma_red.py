"""CPMA consolidado de red por producto — no es la suma de los
calc_cpma individuales. Ver app/repositories/cpma_repository.py."""
...
class CalcCpmaRed(Base):
    __tablename__ = "calc_cpma_red"
    ...
    stock_red: Mapped[float] = mapped_column(Numeric(14, 2), default=0)  # Red (suma de establecimientos)
